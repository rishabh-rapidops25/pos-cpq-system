...
router.post("/register", (0, shared_constants_1.validate)(userSchema_1.registerSchema), userController_1.register);
// Login route with validation middleware
router.post("/login", (0, shared_constants_1.validate)(userSchema_1.loginSchema), userController_1.login);
